...
import {Settings, LoginManager, Profile, AccessToken, GraphRequest, GraphRequestManager} from 'react-native-fbsdk-next'
import {
    GoogleSignin,
    GoogleSigninButton,
    statusCodes,
...
import {GraphRequestCallback} from "react-native-fbsdk-next";
        ...
        Apis.socialLoginCall(request)
            ...
            .then((responce) => {
                if (JSON.parse(responce).data.status == true) {
                    ...
                    console.log("======LoginResponce======", responce);
    ...
    onLogin = () =>{
        ...
        Apis.loginCall(req)
            ...
            .then((responce) => {
                if (JSON.parse(responce).data.status == true) {
                    let data = JSON.parse(responce).data;
                    console.log("dataLoginResponces", data);
    ...
    onLoginPress = () => {
        ...
        if (this.state.email === "" || this.state.email === null) {
            ...
            Apis.loginCall(req)
                ...
                .then((responce) => {
                    console.log("Login_Responces", responce);
                        ...
                        <KeyboardAvoidingView behavior='padding' keyboardVerticalOffset={keyboardVerticalOffset}>
                            ...
                            <View style={{marginVertical: 10}}>
                                ...
                                <Pressable onPress={() => {
                                    ...
                                    <Text style={[styles.regularText, {color: Black, textAlign: 'center'}]}> Forgot
                                        Password ?</Text>
                                </Pressable>
                                <FilledButton
                                    onPress={() => {
                                ...
                                <View style={{flexDirection: 'row', justifyContent: 'center', marginVertical: 5}}>
                                    <Text style={[styles.regularText, {color: Black, textAlign: 'center'}]}> Don't have
                                        account ? </Text>
                                    <Pressable onPress={() => {
